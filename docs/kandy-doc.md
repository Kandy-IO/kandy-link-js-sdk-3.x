...
-   `type` **[string][8]** The type of message that was sent. See [conversation.chatTypes][26] for valid types.
...
Returns **[conversation.Message][27]** The newly created Message object.
